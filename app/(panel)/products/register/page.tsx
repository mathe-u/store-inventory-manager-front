  ...
  const getStatusStyling = (profit: number) => {
    if (profit > 0) {
      return {
        text: "LUCRO",
        badgeClass:
          "mt-3 px-3 py-1 rounded-full text-xs font-bold tracking-wide bg-tertiary-container text-on-tertiary-container",
        valueClass:
          "font-data-tabular text-tertiary-fixed text-4xl font-bold tracking-tight",
      };
    } else if (profit < 0) {
      return {
        text: "PREJUÍZO",
        badgeClass:
          "mt-3 px-3 py-1 rounded-full text-xs font-bold tracking-wide bg-error-container text-on-error-container",
        valueClass:
          "font-data-tabular text-error text-4xl font-bold tracking-tight",
      };
    } else {
      return {
        text: "PONTO DE EQUILÍBRIO",
        badgeClass:
          "mt-3 px-3 py-1 rounded-full text-xs font-bold tracking-wide bg-surface-variant text-on-surface-variant",
        valueClass:
          "font-data-tabular text-primary-fixed text-4xl font-bold tracking-tight",
      };
    }
  };
  ...
  const handleSave = async (e: React.SyntheticEvent) => {
    ...
    try {
      await createProduct({
        ...
        taxRate: (parseFloat(icmsTax) || 0) / 100,
        desiredMargin: (parseFloat(desiredMargin) || 0) / 100,
      ...
      {saveError && (
        <div className="p-4 rounded-xl bg-error-container text-on-error-container border border-error/20 flex items-center gap-3 animate-in fade-in slide-in-from-top-1 duration-200">
          ...
          <button
            ...
            className="ml-auto text-error hover:opacity-70 cursor-pointer"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative flex items-center">
                  <span className="absolute left-3 text-on-surface-variant font-data-tabular font-bold">
                    R$
                  </span>
                  <input
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
              <div>
                ...
                <p className="font-body-md text-body-md text-on-surface-variant mt-1">
                  Ajuste os parâmetros para simular seus resultados financeiros.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 relative z-10">
              ...
              <div className="flex flex-col gap-1.5 p-3 rounded-lg bg-surface border border-outline-variant hover:border-secondary transition-colors group">
                <div className="flex justify-between items-center">
                  ...
                  <span className="material-symbols-outlined text-on-surface-variant text-[16px] group-hover:text-secondary">
                    storefront
                  </span>
                </div>
                <div className="relative flex items-center mt-1">
                  <span className="absolute left-0 text-primary font-data-tabular font-bold text-lg">
                    R$
                  </span>
                  <input
              ...
              <div className="flex flex-col gap-1.5 p-3 rounded-lg bg-surface border border-outline-variant hover:border-secondary transition-colors group">
                ...
                <div className="relative flex items-center mt-1">
                  ...
                  />
                  <span className="absolute right-0 text-primary font-data-tabular font-bold text-lg">
                    %
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5 p-3 rounded-lg bg-surface border border-outline-variant">
                ...
                <div className="relative flex items-center">
                  <span className="absolute left-3 text-on-surface-variant font-data-tabular">
                    R$
                  </span>
                  <input
              ...
              <div className="flex flex-col gap-1.5 p-3 rounded-lg bg-surface border border-outline-variant">
                ...
                <div className="relative flex items-center">
                  ...
                  />
                  <span className="absolute right-3 text-on-surface-variant font-data-tabular">
                    %
                  </span>
                </div>
              </div>
